...
There is wise advice to do not store assets in a single location. This function might be direct tool to manage your assets distributed across different locations.  
...
wallet_dt <- wallet_manager(
  ...
  rate_priority = c('bitstamp','kraken','btce','bitmarket','hitbtc'), # value rates source priority
